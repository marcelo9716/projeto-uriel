...
public class Pedido extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String funcao1 = request.getParameter("funcao1");
            
            PedidoDAO pedido = new PedidoDAO();
            
            if(funcao1.equals("registraPedido")){
                String UsuarioId = request.getParameter("UsuarioId");
                String PizzaId = request.getParameter("PizzaId");
                String Quantidade = request.getParameter("Quantidade");
                pedido.registraPedido(new PedidoBean(request.getParameter("UsuarioId"), request.getParameter("PizzaId"), request.getParameter("Quantidade")));
